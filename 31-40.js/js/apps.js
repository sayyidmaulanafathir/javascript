$(document).ready(function () {
    ...
    function selectUpdate(id) {
        ...
        $.ajax({
            type: "post",
            url: "http://localhost/javascript-smkrepit/31-40.js/php/selectupdate.php",
            caches:false,
    ...
    function selectData() { 
        $.ajax({
            type: "get",
            url: "ttp://localhost/javascript-smkrepit/31-40.js/php/select.php",
            caches:false,
            dataType: "json",
            success: function (response) {
                let out = "";
    ...
    function insertData() { 
        ...
        $.ajax({
            type: "post",
            url: "ttp://localhost/javascript-smkrepit/31-40.js/php/insert.php",
            caches:false,
    ...
    function deleteData(id) { 
        ...
        $.ajax({
            type: "post",
            url: "ttp://localhost/javascript-smkrepit/31-40.js/php/delete.php",
            caches:false,
            data: JSON.stringify(idpelanggan),
            //dataType: "dataType",
            success: function (response) {
    ...
    function updateData() { 
        ...
        $.ajax({
            type: "post",
            url: "ttp://localhost/javascript-smkrepit/31-40.js/php/update.php",
            caches:false,
            data: JSON.stringify(dataPelanggan),
            //dataType: "dataType",
            success: function (response) {
